...
"E:\NvidiaGPU\conda310\python.exe" -u s1_train.py --config_file configs\s1_english.yaml > "d:\Hivericks\Hivericks\train_gpt_stdout.txt" 2> "d:\Hivericks\Hivericks\train_gpt_stderr.txt"
